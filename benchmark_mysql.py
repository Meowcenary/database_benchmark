"""
Script to benchmark mysql queries
"""
...
benchmark_query(mysql_cursor, where_query, iterations)

order_by_query = "SELECT * FROM users ORDER BY phone_number"
benchmark_query(mysql_cursor, order_by_query, iterations)

where_with_order_by_query = "SELECT * FROM users WHERE email LIKE '%gmail%' ORDER BY phone_number"
benchmark_query(mysql_cursor, where_with_order_by_query, iterations)
...
benchmark_query(mysql_cursor, single_inner_join_query_with_order_by_query, iterations)
...
benchmark_query(mysql_cursor, single_inner_join_query_with_where_and_order_by_query, iterations)
...
benchmark_query(mysql_cursor, double_inner_join_query, iterations)
...
benchmark_query(mysql_cursor, double_left_join_query, iterations)
...
benchmark_query(mysql_cursor, double_right_join_query, iterations)
...
benchmark_query(mysql_cursor, double_inner_join_with_where_query, iterations)
...
benchmark_query(mysql_cursor, double_inner_join_query_with_order_by_query, iterations)
...
benchmark_query(mysql_cursor, double_inner_join_query_with_where_and_order_by_query, iterations)
...
benchmark_query(mysql_cursor, triple_inner_join_query, iterations)
...
benchmark_query(mysql_cursor, triple_left_join_query, iterations)
...
benchmark_query(mysql_cursor, triple_right_join_query, iterations)
...
benchmark_query(mysql_cursor, triple_inner_join_query_with_where_query, iterations)
...
benchmark_query(mysql_cursor, triple_inner_join_query_with_order_by_query, iterations)
...
benchmark_query(mysql_cursor, triple_innner_join_query_with_where_and_and_order_by_query, iterations)
